...
color_t COLOR_STAR={255, 255, 0};
color_t COLOR_BARREL={0,0,0};
...
Gift::Gift(float x, float y) {
    ...
    this->object = create3DObject(GL_TRIANGLES, 12*3, vertex_buffer_data, COLOR_BARREL, GL_FILL);
    this->object1 = create3DObject(GL_TRIANGLES, 14*3, pyramids, COLOR_STAR, GL_FILL);
